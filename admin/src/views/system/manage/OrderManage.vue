        ...
        <div class="searchArea">
          <div class="searchForm">
            <el-form :inline="true" class="demo-form-inline">
              <el-form-item label="关键字:" width="400px">
                <el-input
                  v-model="searchParams.key"
                  placeholder="公司名/联系人/联系电话/规格"
                ></el-input>
              </el-form-item>
...
export default {
  ...
  data () {
    return {
      ...
      detailOperateInfo: {},
      //订单状态数组
      typeList: ['审核不通过', '下单', '已审核', '大货确认', '底布进仓', '底部检验', '底布出库', '做货加工', '成品入库', '成品检验', '成品出货', '成品验收', '客户收货', '客户退货'],
      //订单类型数组
      ...
      roleTypeList: [],
      baseUrl: '',
      operateTypeList: ['下单', '已审核', '大货确认', '底布进仓', '底部检验', '底布出库', '做货加工', '成品入库', '成品检验', '成品出货', '成品验收', '客户收货', '客户退货'],
      dialogVisible: false,
      //是否显示订单打印
  ...
  methods: {
    ...
    outExe () {
      if (!this.searchParams.startTime) {
        ...
        // let baseUrl = 'http://192.168.1.115:9911'//线下地址
        let baseUrl = 'https://yc.jiangmiantex.com/jiangjin'//线上地址

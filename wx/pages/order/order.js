...
Page({
  ...
  orderPost(){
    ...
    let flowerMsg = '';
    let _this = this;
    if (this.data.mianliaoList[this.data.fabricIndex] === undefined) {
      wx.showToast({
    ...
    let data = {
      ...
      fkFabricId: this.data.mianliaoList[this.data.fabricIndex].id,
      ...
      otherChargesRate: Number(this.data.approximately)//损益
    }
